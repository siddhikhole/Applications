...
from .models import HelpdeskRequestSLAs, WorkflowRequest, EmployeeMaster, \
    AppList, HelpdeskCategories, HelpdeskOfficeLocation, HelpdeskConfigurationMaster,\
    HelpdeskDepartments, Categories, sub_categories,\
    HelpdeskFulfillerGroups, HelpdeskExpectedClosureDetails,\
    HelpRequest, Workflow_email_templates
...
admin.site.register(HelpdeskFulfillerGroups)
