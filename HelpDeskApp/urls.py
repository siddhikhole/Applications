...
urlpatterns = [url(r'^home/$', views.home, name='home'),
               ...
               path('main/', views.main, name="main"), path('logout/', views.logout, name="logout"),
               ...
               path('HelpdeskFulfillerHead/', views.help_desk_ful_filler_head,
                    name="help_desk_ful_filler_head"),
               ...
               path('get_employee_details/<ticket_id>', views.get_employee_details,
